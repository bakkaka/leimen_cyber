<?php
// src/Controller/Admin/AdminCommentController.php
...
class AdminCommentController extends AbstractController
{
    ...
    {
        // Tous les commentaires, du plus récent au plus ancien
    ...
    public function approve(Comment $comment, EntityManagerInterface $em, Request $request): Response
    {
        ...
        $this->addFlash('success', 'Commentaire approuvé et visible publiquement.');
        return $this->redirectToRoute('app_admin_comments');
    }
