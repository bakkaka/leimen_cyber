 ...
 */
final class Version20260524112000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, created_at DATETIME NOT NULL, entity_id INT NOT NULL, entity_type VARCHAR(50) NOT NULL, is_approved TINYINT NOT NULL, author_id INT NOT NULL, INDEX IDX_9474526CF675F31B (author_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(200) NOT NULL, slug VARCHAR(200) NOT NULL, description LONGTEXT NOT NULL, short_description VARCHAR(300) DEFAULT NULL, level VARCHAR(20) NOT NULL, price INT NOT NULL, image_url VARCHAR(500) DEFAULT NULL, duration INT NOT NULL, is_published TINYINT NOT NULL, created_at DATETIME NOT NULL, sort_order INT DEFAULT NULL, UNIQUE INDEX UNIQ_169E6FB9989D9B62 (slug), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE enrollment (id INT AUTO_INCREMENT NOT NULL, enrolled_at DATETIME NOT NULL, expires_at DATETIME DEFAULT NULL, progress INT NOT NULL, payment_method VARCHAR(50) NOT NULL, payment_id VARCHAR(255) DEFAULT NULL, is_completed TINYINT NOT NULL, student_id INT NOT NULL, course_id INT NOT NULL, INDEX IDX_DBDCD7E1CB944F1A (student_id), INDEX IDX_DBDCD7E1591CC992 (course_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE lesson (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(200) NOT NULL, teaser LONGTEXT DEFAULT NULL, content LONGTEXT DEFAULT NULL, video_url VARCHAR(500) NOT NULL, video_platform VARCHAR(20) NOT NULL, duration INT NOT NULL, order_number INT NOT NULL, is_free_preview TINYINT NOT NULL, key_takeaways JSON DEFAULT NULL, action_item LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, module_id INT NOT NULL, INDEX IDX_F87474F3AFC2B591 (module_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE module (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(200) NOT NULL, description LONGTEXT DEFAULT NULL, order_number INT NOT NULL, created_at DATETIME NOT NULL, course_id INT NOT NULL, INDEX IDX_C242628591CC992 (course_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, full_name VARCHAR(150) DEFAULT NULL, phone VARCHAR(20) DEFAULT NULL, facebook_id VARCHAR(255) DEFAULT NULL, avatar_url VARCHAR(500) DEFAULT NULL, is_verified TINYINT NOT NULL, created_at DATETIME NOT NULL, last_login DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_lesson_progress (id INT AUTO_INCREMENT NOT NULL, completed TINYINT NOT NULL, completed_at DATETIME DEFAULT NULL, video_position INT DEFAULT NULL, last_watched_at DATETIME DEFAULT NULL, student_id INT NOT NULL, lesson_id INT NOT NULL, INDEX IDX_789AD4D0CB944F1A (student_id), INDEX IDX_789AD4D0CDF80196 (lesson_id), UNIQUE INDEX unique_user_lesson (student_id, lesson_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_module_progress (id INT AUTO_INCREMENT NOT NULL, completed TINYINT NOT NULL, completed_at DATETIME DEFAULT NULL, quiz_passed TINYINT NOT NULL, quiz_score INT DEFAULT NULL, user_id INT NOT NULL, module_id INT NOT NULL, INDEX IDX_541D4D37A76ED395 (user_id), INDEX IDX_541D4D37AFC2B591 (module_id), UNIQUE INDEX unique_user_module (user_id, module_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user_quiz_attempt (id INT AUTO_INCREMENT NOT NULL, score INT NOT NULL, passed TINYINT NOT NULL, attempted_at DATETIME NOT NULL, user_id INT NOT NULL, quiz_id INT NOT NULL, INDEX IDX_8A7AD3C4A76ED395 (user_id), INDEX IDX_8A7AD3C4853CD175 (quiz_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
